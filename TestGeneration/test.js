...
subject.normalize('244-724-9947');
subject.format('','',false);
subject.format('566-844-8121','###.###.####',{normalize:true});
subject.format('566-844-8121','###.###.####',{normalize:false});
subject.format('566-844-8121','###.###.####',false);
subject.blackListNumber('');
subject.blackListNumber('(212) 234-5644');
subject.blackListNumber('299-998-8249');
